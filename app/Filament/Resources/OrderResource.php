...
class OrderResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Group::make()->schema([
                    Section::make('Oder Information')->schema([
                        Select::make('user_id')
                            ->label('Customer')
                        ...
                        Repeater::make('items')
                            ...
                            ->schema([
                                Select::make('product_id')
                                    ...
                                    ->afterStateUpdated(
                                        fn($state, Set $set, Get $get) => $set('total_amount', Product::find($state)?->price * $get('quantity') ?? 0)
                                    ),
    ...
    {
        return static::getModel()::count() > 2 ? 'succes' : 'danger';
    }
